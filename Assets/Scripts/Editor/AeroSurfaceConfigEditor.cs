...
[CustomEditor(typeof(AeroSurfaceSO)), CanEditMultipleObjects()]
public class AeroSurfaceConfigEditor : Editor
{
    ...
    private void OnEnable()
    {
        ...
        config = target as AeroSurfaceSO;
    }
